...
$subject = 'Reminder';
$to = 'v.jashwanthreddy@gmail.com'; // an email address is required to be given here.
...
{
$Status_message = "There are no events set today,Today is : " .date('Y-m-d, H:i:s'); // if there are no active remindes set today.
}
