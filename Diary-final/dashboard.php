...
<div class="right col-md-1">
  ...
  <!-- Add note button -->
  <a class="newBtn" href="newnote.php"><i style="font-size:24px" class="fa fa-book"></i></a>
  <a class="newBtnRem" href="./index1.php?email=<?php echo $email?>"><i style="font-size:24px" class="fa fa-calendar"></i></a>
  <a class="newBtnCon" href="./index2.php?email=<?php echo $email?>"><i style="font-size:24px" class="fa fa-address-book"></i></a>



  <!-- logout button -->
  <a class="logoutBtn" href="./index.html">Logout</a>
